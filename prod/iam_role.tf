resource "aws_iam_role" "tfer--AWSReservedSSO_AdministratorAccess_6dc64117fc3def79" {
  ...
  "Statement": [
    {
      ...
      "Effect": "Allow",
      "Principal": {
        "Federated": "arn:aws:iam::251344704583:saml-provider/AWSSSO_455b51205747730c_DO_NOT_DELETE"
      }
    }
  ],
  "Version": "2012-10-17"
...
POLICY
  ...
  name                 = "AWSReservedSSO_AdministratorAccess_6dc64117fc3def79"
...
resource "aws_iam_role" "tfer--sample-app-role-prod" {
  assume_role_policy = <<POLICY
{
  "Statement": [
    {
