resource "aws_iam_role_policy_attachment" "tfer--AWSReservedSSO_AdministratorAccess_ebe7cc3131876224_AdministratorAccess" {
  policy_arn = "arn:aws:iam::aws:policy/AdministratorAccess"
  role       = "AWSReservedSSO_AdministratorAccess_ebe7cc3131876224"
}
